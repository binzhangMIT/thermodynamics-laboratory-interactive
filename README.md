# Thermodynamics Laboratory Interactive

Interactive Jupyter notebook for the 5.70 thermodynamics laboratory.
...
top to bottom. No local Python installation is required.

## Run locally

Install the packages listed in `requirements.txt`, then open the notebook with
Jupyter.
